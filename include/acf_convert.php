...
function save_group($group) {
    ...
    $file = file_put_contents( $acfJsonPath . $group['id'] . '.json', $json );
}
...
$faq_section_headers_ordered = array_map('trim', explode('|', "What the Heck?|Booking Questions|I’m Booked! Now What?|Managing my Booking"));
...
//echo json_encode($artistYearAndTypeFields,JSON_PRETTY_PRINT);
