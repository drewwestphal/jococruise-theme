...
function sf_red_options() {
	...
	for ($i=0;isset($red[$i]);$i++)
		echo '<div data-idx="'.$i.'"><input type="text" name="sf_red['.$i.'][0]" value="'.$red[$i][0].'" style="width:300px;"><span> &raquo; </span><input type="text" name="sf_red['.$i.'][1]" value="'.$red[$i][1].'" style="width:300px;"><select name="sf_red['.$i.'][2]"><option value="2"'.($red[$i][2]=='2'?' selected="selected"':'').'>'.__('302 Moved Temporarily','redirect-list').'</option><option value="7"'.($red[$i][2]=='7'?' selected="selected"':'').'>'.__('307 Temporary Redirect','redirect-list').'</option><option value="1"'.($red[$i][2]=='1'?' selected="selected"':'').'>'.__('301 Moved Permanently','redirect-list').'</option><select></div>';
	echo '<div data-idx="'.$i.'"><input type="text" name="sf_red['.$i.'][0]" onchange="if (this.value) sf_red_add();" placeholder="'.__('url-to-match','redirect-list').'" style="width:300px;"><span> &raquo; </span><input type="text" name="sf_red['.$i.'][1]" placeholder="destination-url" style="width:300px;"><select name="sf_red['.$i.'][2]"><option value="2">302 Moved Temporarily</option><option value="7">307 Temporary Redirect</option><option value="1">301 Moved Permanently</option><select></div>'
		.'</div>'
